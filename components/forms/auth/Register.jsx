    ...
    <div className="min-h-screen bg-[#1a1a1a] text-white flex items-center justify-center py-12">
      {showTaller ? (
        ...
        >
          ...
          <button
            type="button"
            className="w-full mt-2 bg-[#333] text-orange-400 py-2 rounded-md hover:bg-orange-700 hover:text-white font-semibold transition-colors"
            onClick={() => setShowTaller(true)}
          >
            ¿Eres un taller? Regístrate aquí
          </button>
