...
const Modal = ({ 
  ...
  return (
    ...
    >
      <div className={`bg-gray-800 rounded-lg shadow-xl max-w-md w-full mx-4 transform transition-all duration-300 ${typeConfig.bgColor} ${typeConfig.borderColor} border-2`}>
        {/* Header */}
